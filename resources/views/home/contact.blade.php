    ...
    <section id="contact" class="contact section-bg about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2 style="color: white;" class="vid" vid-path="{{ asset('assets/vid/nf3.mp4') }}">تــــواصـــل مــعنا</h2>
                <p style="color: white;">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-6">
                    <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                        ...
                        {{-- <div class="form-group">
                        <input type="file" class="form-control file-upload" name="video" id="video" accept="video/*">
                    </div> --}}
                        <div class="form-group">
