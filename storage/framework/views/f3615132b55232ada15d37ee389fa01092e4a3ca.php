            ...
            <ul class="nav nav-tabs  row row-cols-md-5  gy-3">
                <li class="col-12">
                    <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#tab-1">
                        <img src="<?php echo e(asset('assets/img/icons/1.png')); ?>" class="d-block">
                ...
                <li class=" col-12">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-2">
                        ...
                        <img src="<?php echo e(asset('assets/img/icons/2.png')); ?>" class="d-block">
                        <h6>
                ...
                <li class="col-12">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-3">
                        ...
                        <img src="<?php echo e(asset('assets/img/icons/33.png')); ?>" class="d-block" alt="...">
                ...
                <li class="col-12">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-4">
                        ...
                        <img src="<?php echo e(asset('assets/img/icons/44.png')); ?>" class="d-block" alt="...">
                ...
                <li class="col-12">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-5">
                        <!-- <i class="ri-store-line"></i> -->
                        <img src="<?php echo e(asset('assets/img/icons/55.png')); ?>" class="d-block00" alt="...">
            ...
            <div class="tab-content">
                <div class="tab-pane active show" id="tab-1">
                    <div class="row info-box">
                        <div class=" col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <p class=" text-justify vid " vid-path="<?php echo e(asset('assets/vid/تمويل شراء سياره جديده.mp4')); ?>">
                            ...
                            <p class=" text-justify vid " vid-path="<?php echo e(asset('assets/vid/nf2.mp4')); ?>">
                        ...
                        <div class="video-container">
                            <video id="vid1" src="<?php echo e(asset('assets/vid/الاتصال المرئي.mp4')); ?>"
                                controls="true"></video>
                            <!-- <video src="<?php echo e(asset('assets/vid/C0089.mp4')); ?>" controls="true"></video> -->
                            <img src="<?php echo e(asset('assets/img/icons/removeicon.png')); ?>" class="close" onclick="toggle(0);">
                        </div>
                        <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                            <img src="<?php echo e(asset('assets/img/services/الاتصال المرئي.png')); ?>" alt=""
                ...
                <div class="tab-pane" id="tab-2">
                    <div class="row info-box">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                            ...
                            <p class=" text-justify  vid" vid-path="<?php echo e(asset('assets/vid/nf3.mp4')); ?>">
                        ...
                        <div class="video-container">
                            <video src="<?php echo e(asset('assets/vid/جائزة بلعرب بن هيثم للتصميم المعماري.mp4')); ?>"
                                controls="true"></video>
                            <img src="<?php echo e(asset('assets/img/icons/removeicon.png')); ?>" class="close" onclick="toggle(1);">
                        </div>
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="<?php echo e(asset('assets/img/services/الترجمة الإشارية للمحتوى المكتوب والمسموع.png')); ?>"
                ...
                <div class="tab-pane" id="tab-3">
                    <div class="row info-box">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 vid "
                            vid-path="<?php echo e(asset('assets/vid/nf2.mp4')); ?>">
                        ...
                        <div class="video-container">
                            <video src="<?php echo e(asset('assets/vid/كود.mp4')); ?>" controls="true"></video>
                            <img src="<?php echo e(asset('assets/img/icons/removeicon.png')); ?>" class="close"
                                onclick="toggle(2);">
                        </div>
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="<?php echo e(asset('assets/img/services/qr code.png')); ?>" alt=""
                                class="imgservice-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row info-box">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 ">
                            ...
                            <p class=" text-justify vid " vid-path="<?php echo e(asset('assets/vid/nf2.mp4')); ?>">
                                ...
                                ​ </p>
                            <div class="text-justify vid " vid-path="<?php echo e(asset('assets/vid/nf2.mp4')); ?>">
                                <h3>ميزات الخدمة:</h3>
                                <ul>
                        ...
                        <div class="video-container">
                            <video src="<?php echo e(asset('assets/vid/خدمة ترجمة الفعاليات.mp4')); ?>" controls="true"></video>
                            <img src="<?php echo e(asset('assets/img/icons/removeicon.png')); ?>" class="close"
                                onclick="toggle(3);">
                        </div>
                        <div class="col-lg-6 order-1 order-lg-2 text-center ">
                            <img src="<?php echo e(asset('assets/img/services/الترجمة الإشارية الفورية للورش والفعاليات.png')); ?>"
                                alt="" class="imgservice-fluid">
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="tab-5">
                    <div class="row info-box y-5">
                        ...
                        <div class="video-container">
                            <video src="<?php echo e(asset('assets/vid/ترجمة موقع رؤية عمان2040.mp4')); ?>" controls="true"></video>
                            <img src="<?php echo e(asset('assets/img/icons/removeicon.png')); ?>" class="close"
                                onclick="toggle(4);">
                        </div>
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="<?php echo e(asset('assets/img/services/اضافة المكون الإشاري للمواقع الالكترونية.png')); ?>"
                                alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
        ...
        <div class="container" data-aos="fade-up">
            <div class="row row-cols-md-5   gy-5">
                <div class="col-12 ">
                    <div class="count-box">
                        <i>
                            <img src="<?php echo e(asset('assets/img/icons/ترجمة (3).png')); ?>" class="d-block w-100 "
                                alt="...">
                        </i>
                ...
                <div class="col-12 ">
                    <div class="count-box">
                        <i>
                            <img src="<?php echo e(asset('assets/img/icons/ترجمة (2).png')); ?>" class="d-block w-100 "
                                alt="...">
                        </i>
                ...
                <div class="col-12 ">
                    <div class="count-box">
                        <i>
                            <img src="<?php echo e(asset('assets/img/icons/3.png')); ?>" class="d-block w-100 " alt="...">
                        </i>
                ...
                <div class="col-12 ">
                    <div class="count-box">
                        <i> <img src="<?php echo e(asset('assets/img/icons/4.png')); ?>" class="d-block w-100 " alt="...">
                        </i>
                ...
                <div class="col-12 ">
                    <div class="count-box">
                        <i> <img src="<?php echo e(asset('assets/img/icons/5.png')); ?>" class="d-block w-100 " alt="...">
                        </i>
