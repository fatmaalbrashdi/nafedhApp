...
<?php $__env->startSection('body'); ?>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="<?php echo e(asset('assets/img/مدير1.png')); ?>"  class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item vid" data-bs-interval="2000" vid-path="<?php echo e(asset('assets/vid/33.mp4')); ?>">
      <img src="<?php echo e(asset('assets/img/قيمنا.png')); ?>" class="d-block w-100" style="mix-blend-mode:screen" alt="...">
    </div>
  </div>
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                <div class="col-12 col-md-4">
                    <div class=" feature-1 position-relative vid" vid-path="<?php echo e(asset('assets/vid/nf1.mp4')); ?>"
                        data-aos="fade-up" data-aos-delay="200">
                        <div class="text-center">
                            <div class="wrap-icon icon-1">
                                <i>
                                    <img src="<?php echo e(asset('assets/img/icons/الهدف.png')); ?>" class="d-block w-100"
                                        alt="...">
                                </i>
                            </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="vid feature-1  position-relative" vid-path="<?php echo e(asset('assets/vid/nf3.mp4')); ?>"
                        data-aos="fade-up" data-aos-delay="200">
                        <div class="text-center">
                            <div class="wrap-icon icon-1">
                                <i>
                                    <img src="<?php echo e(asset('assets/img/icons/الرسالة.png')); ?>" class="d-block w-100"
                                        alt="...">
                                </i>
                            </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="vid feature-1  position-relative" vid-path="<?php echo e(asset('assets/vid/nf2.mp4')); ?>"
                        data-aos="fade-up" data-aos-delay="200">
                        <div class="text-center">
                            <div class="wrap-icon icon-1">
                                <i>
                                    <img src="<?php echo e(asset('assets/img/icons/الرؤية.png')); ?>" class="d-block w-100"
                                        alt="...">
                                </i>
                            </div>
                ...
                <div class="row gy-4 portfolio-container">
                        ...
                        <div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src="<?php echo e(asset('assets/img/Posts/مشاركه2.jpg')); ?>" class="card-img-top img-fluid"
                                        alt="...">
                                    <div class="card-body">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-external">
                        <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src= "<?php echo e(asset('assets/img/Posts/معرض_اكسبو_أصحاب_الهمم_الدولي_2022.jpg')); ?>"
                                ...
                                <div class="card portfolio-wrap carousel-item">
                                    <img src="<?php echo e(asset('assets/img/Posts/معرض_اكسبو_أصحاب_الهمم_الدولي_2019.png')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-external">
                        <div id="carouselExampleIndicators3" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src="<?php echo e(asset('assets/img/Posts/زيارة الوفد العماني.jpg')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-external">
                        <div id="carouselExampleIndicators4" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src="<?php echo e(asset('assets/img/Posts/معرض كومكس البحرين.jpg')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        <p class="card-text">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-external">
                        <div id="carouselExampleIndicators5" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src="<?php echo e(asset('assets/img/Posts/المعرض السعودي الدولي لمستلزمات.jpg')); ?> "
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        <p class="card-text">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-internal">
                        <div id="carouselExampleIndicators6" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src=" <?php echo e(asset('assets/img/Posts/ملتقى الأشخاص ذوي الإعاقة الأول.jpg')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        <p class="card-text">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-internal">
                        <div id="carouselExampleIndicators7" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src="<?php echo e(asset('assets/img/Posts/معرض_كومكس_2023.jpg')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        <p class="card-text ">
                                ...
                                <div class="card portfolio-wrap carousel-item">
                                    <img src="<?php echo e(asset('assets/img/Posts/معرض_كومكس_2022.png')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        <p class="card-text ">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-internal">
                        <div id="carouselExampleIndicators8" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="card portfolio-wrap carousel-item active">
                                    <img src="<?php echo e(asset('assets/img/Posts/ترجمة جلسات ملهمون.jpg')); ?>"
                                        class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        <p class="card-text ">
